...
import id.ac.unpas.functionalcompose.persistences.DataElektronikDao
import id.ac.unpas.functionalcompose.ui.theme.Purple700
import id.ac.unpas.functionalcompose.ui.theme.Teal200
import kotlinx.coroutines.launch

@Composable
fun FormPencatatanElektronik(dataElektronikDao: DataElektronikDao) {
    ...
    Column(modifier = Modifier
        ...
        .fillMaxWidth()) {
        OutlinedTextField(
            label = { Text(text = "Tanggal Pencatatan") },
            value = tanggal.value,
            onValueChange = {
                tanggal.value = it
            },
        ...
        OutlinedTextField(
            label = { Text(text = "Nama Elektronik") },
            value = nama.value,
            onValueChange = {
                nama.value = it
            },
        ...
        OutlinedTextField(
            label = { Text(text = "Jenis Elektronik") },
            value = jenis.value,
            onValueChange = {
                jenis.value = it
            },
        ...
        OutlinedTextField(
            label = { Text(text = "Harga Elektronik") },
            value = harga.value,
            onValueChange = {
                harga.value = it
            },
        ...
        Row (modifier = Modifier
            ...
            Button(modifier = Modifier.weight(5f), onClick = {
                ...
                val item = DataElektronik(id, tanggal.value.text,
                    nama.value.text, jenis.value.text, harga.value.text)
                scope.launch {
                    dataElektronikDao.insertAll(item)
                }
